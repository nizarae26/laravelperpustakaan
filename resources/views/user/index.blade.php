...
<div class="card shadow">
    ...
    <div class="d-flex justify-content-end mb-4">
        ...
        <a href="#modalTambahUser" data-toggle="modal" class="btn btn-success btn-md mb-2"><span class="fa fa-plus mr-2"></span>Tambah Data</a>
                ...
                <tr class="text-center">
                    ...
                    <td style="text-align: center ;">
                        <div class="form-button-action">
                            <a type="button" data-toggle="modal" title="" href="#modalEditUser{{ $row->id }}" class="btn btn-link btn-primary btn-lg " data-original-title="Edit">
...
<!-- Modal Edit User -->
@foreach ($data as $dd)
<div class="modal fade" id="modalEditUser{{ $dd->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="/User/{{ $dd->id }}/updateUser" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="mb-2">
                            <label for="name" class="form-label">Nama</label>
                            <input type="text" name="name" class="form-control" value="{{ $dd->name }}">
                            @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="mb-2">
                            <label for="email" class="form-label">email</label>
                            <input type="email" name="email" class="form-control" value="{{ $dd->email }}">
